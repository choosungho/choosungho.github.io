...
<link rel="stylesheet" href="/9/css/smaple.css">
...
<div id="div1" class="class1">
  <label id="id11" class="class2" for="id 12">이름</label>
  <% Srting sName - request.getParameter("sName");
  <input id="id12" class="class3" tytpe="text" name="sName" size="20" maxlength="50" value='"+
sName +"'/>");%></div>
<div id="div2" class="class1">
  <label id="id21" class="class2" for="id 22">학번</label>
  <%= request.getParameter("sNumber")%></div>
<div id="div3">
  <label id="id31" for="id32">전화</label>
  <%= request.getParameter("sPhone")%></div>
<div id="div4">
  <footer><p>©20XX Made by Korea. All rights reserved.</p></footer></body></html>
